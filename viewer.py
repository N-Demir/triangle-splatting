...
def main(local_rank: int, world_rank, world_size: int, args):
    ...
    def viewer_render_fn(camera_state: CameraState, render_tab_state: RenderTabState):
        ...
        elif args.backend == "triangle-splatting":
        ...
        if args.backend == "triangle-splatting":
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--backend", type=str, default="gsplat", choices=["gsplat", "triangle-splatting", "inria"], help="backend to use for rendering",
    )
    parser.add_argument(
